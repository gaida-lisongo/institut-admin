'use client';
import { Message } from "@/services/SocketManager";
...
export default function ChatLayoutOptimized() {
    ...
    // Utilisation du hook socket optimisé
    const { socketManager } = useSocket({
        user: currentUser,
        onAuth: handleAuth,
        onRoomJoined: renderRoom,
        onNewMessage: renderNewMessage,
        onDeleteMessage: renderDeletedMessage
    });
    ...
    }, [newMessage, attachments, currentUser, handleSubmitMessage]);
    ...
    // Mémoriser le rendu des messages pour éviter les re-renders inutiles
    ...
    }, [currentRoom, getUserInfo, isMyMessage, formatTime, getFileNameFromUrl, isImageUrl, handleDeleteMessage]);
