...
export const metadata: Metadata = {
  title: "Épreuve en ligne | Institut d'Administration",
  description: "Plateforme d'évaluation en ligne sécurisée",
  robots: {
    index: false,
    follow: false,
  },
  openGraph: {
    title: "Épreuve en ligne",
    description: "Système d'évaluation sécurisé",
    type: 'website',
  },
};
...
export default function EpreuveLayout({
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-purple-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
        {/* Header de l'épreuve */}
