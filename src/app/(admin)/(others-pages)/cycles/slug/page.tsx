...
export default function CyclesPage({ params }: PageProps) {
  ...
  return (
    <div className="p-6">
      <PageBreadcrumb 
        pageTitle={`Cycles ${currentSection ? `- ${currentSection.description?.designation}` : ""}`} 
      />
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              {currentSection 
                ? `Cycles de la section ${currentSection.description?.designation}` 
                : "Gérez les cycles de formation"
              }
            </p>
          </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900 rounded-lg flex items-center justify-center">
                <span className="text-blue-600 dark:text-blue-400 font-bold text-lg">
                  {currentSection.description?.sigle || currentSection.description?.designation?.charAt(0)}
                </span>
              </div>
              <div>
