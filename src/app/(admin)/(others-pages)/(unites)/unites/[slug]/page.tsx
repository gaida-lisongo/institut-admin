...
const UnitesByYearPage: React.FC = () => {
  ...
  const yearId = params.slug as string;

  useEffect(() => {
    if (menuData && menuData.unites && yearId) {
      // Filtrer les unités pour l'année spécifique
      const unitesForYear = menuData.unites.filter(unite => 
        unite.responsable.some(resp => {
          if (typeof resp.anneeId === 'object') {
            return resp.anneeId._id === yearId;
          }
          return resp.anneeId === yearId;
        })
      );

      // Trouver l'année courante
      const year = menuData.unites
        .flatMap(u => u.responsable)
        .find(resp => {
          if (typeof resp.anneeId === 'object') {
            return resp.anneeId._id === yearId;
          }
      ...
      if (year && typeof year.anneeId === 'object') {
        setCurrentYear(year.anneeId);
      }

      setUnites(unitesForYear);
      setFilteredUnites(unitesForYear);
      setLoading(false);
    }
  }, [menuData, yearId]);
  ...
  return (
    <div className="p-6">
      {/* Header avec informations sur l'année */}
      <div className="mb-6">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h2 className="text-xl font-bold text-blue-900 dark:text-blue-100">
                  Année Académique {currentYear.debut} - {currentYear.fin}
                </h2>
                <p className="text-blue-700 dark:text-blue-300">
                  Unités d'enseignement dont vous êtes responsable pour cette année
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-blue-600 dark:text-blue-400">Unités cette année</p>
          ...
          <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg border border-purple-200 dark:border-purple-800">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-purple-600 dark:text-purple-400">Crédits</p>
        ...
        <div className="text-center py-12">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            {searchTerm || selectedType !== 'all' 
              ...
              : currentYear 
                ? `Vous n'avez pas d'unités d'enseignement assignées pour l'année ${currentYear.debut}-${currentYear.fin}.`
                : 'Aucune unité trouvée pour cette année.'
            }
          </p>
        </div>
      ) : (
...
export default UnitesByYearPage;