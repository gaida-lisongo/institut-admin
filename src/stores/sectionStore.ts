...
interface SectionState {
  ...
  addGaleryToSection: (sectionId: string, galery: Galery) => Promise<boolean>;
  updateGaleryInSection: (sectionId: string, galeryIndex: number, galery: Galery) => Promise<boolean>;
  removeGaleryFromSection: (sectionId: string, galeryIndex: number) => Promise<boolean>;
  
  // Actions pour les événements dans la galerie
  updateEventsInGalery: (sectionId: string, galeryIndex: number, events: Event[]) => Promise<boolean>;
  ...
  // Actions pour les événements dans l'agenda
  updateEventsInAgenda: (sectionId: string, agendaIndex: number, events: AgendaEvent[]) => Promise<boolean>;
  ...
  devtools(
    persist(
      (set, get) => ({
        ...
        // Méthodes pour gérer la galerie
        addGaleryToSection: async (sectionId, galery) => {
          set({ isLoading: true, error: null });
          try {
            const section = get().sections.find(s => s._id === sectionId);
            if (!section) {
            ...
            if (result.status === 200 && result.data.success) {
              ...
              set({
                error: result.data?.message || 'Erreur lors de l\'ajout de la galerie',
                isLoading: false
              });
              return false;
            }
            ...
            set({
              error: error instanceof Error ? error.message : 'Erreur lors de l\'ajout de la galerie',
              isLoading: false
            });
            return false;
          }
        ...
        updateGaleryInSection: async (sectionId, galeryIndex, galery) => {
          set({ isLoading: true, error: null });
          try {
            const section = get().sections.find(s => s._id === sectionId);
            if (!section) {
            ...
            const updatedGalery = [...section.galery];
            updatedGalery[galeryIndex] = galery;

            const updatedSection = {
              ...section,
              galery: updatedGalery
            };
            ...
            if (result.status === 200 && result.data.success) {
              ...
              set({
                error: result.data?.message || 'Erreur lors de la modification de la galerie',
                isLoading: false
              });
              return false;
            }
            ...
            set({
              error: error instanceof Error ? error.message : 'Erreur lors de la modification de la galerie',
              isLoading: false
            });
            return false;
          }
        ...
        removeGaleryFromSection: async (sectionId, galeryIndex) => {
          set({ isLoading: true, error: null });
          try {
            const section = get().sections.find(s => s._id === sectionId);
            if (!section) {
            ...
            const updatedGalery = section.galery.filter((_, index) => index !== galeryIndex);
            ...
            if (result.status === 200 && result.data.success) {
              ...
              set({
                error: result.data?.message || 'Erreur lors de la suppression de la galerie',
                isLoading: false
              });
              return false;
            }
            ...
            set({
              error: error instanceof Error ? error.message : 'Erreur lors de la suppression de la galerie',
              isLoading: false
            });
            return false;
          }
        ...
        updateEventsInGalery: async (sectionId, galeryIndex, events) => {
          set({ isLoading: true, error: null });
          try {
            const section = get().sections.find(s => s._id === sectionId);
            if (!section) {
            ...
            if (result.status === 200 && result.data.success) {
              ...
              set({
                error: result.data?.message || 'Erreur lors de la modification des événements de la galerie',
                isLoading: false
              });
              return false;
            }
            ...
            set({
              error: error instanceof Error ? error.message : 'Erreur lors de la modification des événements de la galerie',
              isLoading: false
            });
            return false;
          }
        ...
        updateAgendaInSection: async (sectionId, agendaIndex, agenda) => {
          ...
          try {
            ...
            const updatedAgenda = [...section.agenda];
            updatedAgenda[agendaIndex] = agenda;
        ...
        removeAgendaFromSection: async (sectionId, agendaIndex) => {
          ...
          try {
            ...
            const updatedAgenda = section.agenda.filter((_, index) => index !== agendaIndex);
        ...
        updateEventsInAgenda: async (sectionId, agendaIndex, events) => {
          set({ isLoading: true, error: null });
          try {
            const section = get().sections.find(s => s._id === sectionId);
            if (!section) {
            ...
            if (result.status === 200 && result.data.success) {
              ...
              set({
                error: result.data?.message || 'Erreur lors de la modification des événements de l\'agenda',
                isLoading: false
              });
              return false;
            }
            ...
            set({
              error: error instanceof Error ? error.message : 'Erreur lors de la modification des événements de l\'agenda',
              isLoading: false
            });
            return false;
          }
